...
INSERT INTO CUENTA (NUMERO, TIPO, CLIENTE_ID, ESTADO) VALUES ('111', 'AHORRO', 1, true);
INSERT INTO CUENTA (NUMERO, TIPO, CLIENTE_ID, ESTADO) VALUES ('222', 'CORRIENTE', 1, true);
INSERT INTO CUENTA (NUMERO, TIPO, CLIENTE_ID, ESTADO) VALUES ('333', 'Plazo', 2, true);

INSERT INTO TARJETA (NUMERO, TIPO, CLIENTE_ID, ESTADO) VALUES ('1234567812345678', 'CASH', 1, false);
INSERT INTO TARJETA (NUMERO, TIPO, CLIENTE_ID, ESTADO) VALUES ('1234567812345677', 'CASH', 2, true);

INSERT INTO INVERSION (NUMERO, TIPO, CLIENTE_ID, ESTADO) VALUES ('1', 'PLAZO', 1, true);